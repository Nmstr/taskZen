...
permalink: /deviceReference/availableKeys/
...
taskZen offers a lot of keys. Here is a short list of the most common ones:
```
KEY_RIGHTCTRL
KEY_LEFTCTRL
KEY_RIGHTSHIFT
...
All the other keys can be found inside this list:
```
BTN_0
BTN_MISC
BTN_1
